...
public class GuiHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        case BLAST_FURNACE_GUI_ID :
            return new BlastFurnaceContainer(player.inventory, (TileBlastFurnaceCore) world.getTileEntity(x, y, z));
        }
        return null;
    }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        switch(ID) {
        case BLAST_FURNACE_GUI_ID :
            return new GuiBlastFurnace(player.inventory, (TileBlastFurnaceCore) world.getTileEntity(x, y, z));
        }
        return null;
    }
}

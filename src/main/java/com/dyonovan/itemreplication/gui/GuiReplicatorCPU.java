...
import com.dyonovan.itemreplication.container.ContainerReplicatorCpu;
...
public class GuiReplicatorCPU extends BaseGui {

    private TileReplicatorCPU tile;
    private ResourceLocation background = new ResourceLocation(Constants.MODID + ":textures/gui/replicator_cpu.png");

    public GuiReplicatorCPU(InventoryPlayer playerInventory, TileReplicatorCPU tileEntity) {
        super(new ContainerReplicatorCpu(playerInventory, tileEntity));
    ...
    {
        final String invTitle = "Replicator CPU";

package com.dyonovan.modernalchemy.client.gui.config;

import com.dyonovan.modernalchemy.client.gui.BaseGui;
import com.dyonovan.modernalchemy.client.gui.buttons.ItemStackButton;
...
public class GuiSuperTeslaCoilLinks extends BaseGui {

    private TileSuperTeslaCoil tile;
    private ResourceLocation background = new ResourceLocation(Constants.MODID + ":textures/gui/coil_link.png");
    private int index1;

    public GuiSuperTeslaCoilLinks(TileSuperTeslaCoil tileEntity) {
        super(new ContainerSuperTeslaCoilLinks());
        tile = tileEntity;
    }
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        PacketHandler.net.sendToServer(new UpdateServerSuperCoilLists.UpdateMessage(tile.xCoord, tile.yCoord, tile.zCoord,
